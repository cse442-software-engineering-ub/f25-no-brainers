...
export default function ConfirmMessageCard({ message, isMine, onRespond }) {
  ...
  return (
    <div
      className={`w-full max-w-md border rounded-2xl px-4 py-3 text-sm shadow ${visual.container}`}
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <span
          className={`text-xs font-semibold px-3 py-1 rounded-full ${visual.badge}`}
        >
      ...
      <div className="mt-3 space-y-2 text-gray-800 dark:text-gray-100">
        ...
        {!isSuccessful && failureReasonLabel && (
          <div>
            ...
            {failureReasonNotes && (
              <p className="whitespace-pre-wrap text-gray-800 dark:text-gray-100 mt-0.5">
                {failureReasonNotes}
              </p>
            )}
          </div>
