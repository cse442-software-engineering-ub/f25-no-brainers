...
export default function ConfirmPurchasePage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setFormSuccess(
        "Sent! The buyer now has 24 hours to accept or deny this confirmation."
      );
      setFormError("");
    } catch (err) {
      setFormError(
          ...
          <>
            <section className="bg-gray-50 dark:bg-gray-900/40 rounded-lg p-4">
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Review what you agreed with the buyer. Once submitted, the buyer
                will have 24 hours to accept or deny the confirmation. If they
                do nothing, it will automatically be accepted.
              </p>
            </section>
