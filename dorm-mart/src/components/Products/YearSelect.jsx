  ...
  return (
    <div className="relative w-full sm:max-w-md">
      ...
      <label
        ...
        className="block mb-2 text-base sm:text-base font-medium text-gray-700 dark:text-gray-300"
      >
        Select year
      </label>
              ...
              <li key={y}>
                <button
                  ...
                  className={`
                    ...
                    ${selected ? "bg-blue-50 dark:bg-blue-900 text-blue-700 dark:text-blue-300" : "text-gray-900 dark:text-gray-100"}
